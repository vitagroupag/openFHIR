...
public class OpenFhirStringUtilsTest {
    ...
    public void getFhirPathWithConditions() {
        ...
        Assert.assertEquals("MedicationStatement.medication.resolve().ingredient", openFhirStringUtils.getFhirPathWithConditions("MedicationStatement.medication.resolve().ingredient",
                null,
                "MedicationStatement",
        ...
        condition.setOperator("one of");
        Assert.assertEquals("MedicationStatement.identifier.where(system.toString().contains('external identifier'))", openFhirStringUtils.getFhirPathWithConditions("MedicationStatement.identifier",
                condition,
                "MedicationStatement",
                null));
        ...
        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().onset.as(Period)",
                openFhirStringUtils.getFhirPathWithConditions("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().onset.as(Period)",
                        null,
                        "Condition",
                        "Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve()"));

        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value",
        ...
        condition = new Condition();
        condition.setTargetRoot("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().extension");
        condition.setTargetAttribute("url");
        condition.setCriteria("[http://hl7.org/fhir/StructureDefinition/condition-assertedDate]");
        condition.setOperator("one of");
        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-assertedDate')).value.as(DateTimeType)",
                openFhirStringUtils.getFhirPathWithConditions("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().extension.value.as(DateTimeType)",
                        condition,
                        "Condition",
                        "Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve()"));

        condition = new Condition();
        condition.setTargetRoot("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.as(Reference).resolve().code.coding.extension");
        condition.setTargetAttribute("url");
        condition.setCriteria("[http://fhir.de/StructureDefinition/icd-10-gm-mehrfachcodierungs-kennzeichen]");
        condition.setOperator("one of");
        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.as(Reference).resolve().code.coding.where(system.toString().contains('http://fhir.de/CodeSystem/bfarm/icd-10-gm')).extension.where(url.toString().contains('http://fhir.de/StructureDefinition/icd-10-gm-mehrfachcodierungs-kennzeichen'))",
                openFhirStringUtils.getFhirPathWithConditions("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.as(Reference).resolve().code.coding.extension",
                        condition,
                        "Condition",
    ...
    public void testSettingParentsPath() {
        ...
        String s = openFhirStringUtils.setParentsWherePathToTheCorrectPlace("Procedure.code.coding.extension.value",
                "Procedure.code.coding.where(system.toString().contains('http://fhir.de/CodeSystem/bfarm/ops'))");
        Assert.assertEquals("Procedure.code.coding.where(system.toString().contains('http://fhir.de/CodeSystem/bfarm/ops')).extension.value", s);

        s = openFhirStringUtils.setParentsWherePathToTheCorrectPlace("Condition.extension.value",
                "Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related'))");
        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value", s);
        ...
        s = openFhirStringUtils.setParentsWherePathToTheCorrectPlace("MedicationStatement.medication.resolve().ingredient",
                "MedicationStatement.medication.resolve()");
        ...
        s = openFhirStringUtils.setParentsWherePathToTheCorrectPlace("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().onset.as(Period)",
                "Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve()");
        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.resolve().onset.as(Period)", s);

        s = openFhirStringUtils.setParentsWherePathToTheCorrectPlace("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.as(Reference).resolve().code.coding.extension",
                "Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.as(Reference).resolve().code.coding.where(system.toString().contains('http://fhir.de/CodeSystem/bfarm/icd-10-gm'))");
        Assert.assertEquals("Condition.extension.where(url.toString().contains('http://hl7.org/fhir/StructureDefinition/condition-related')).value.as(Reference).resolve().code.coding.where(system.toString().contains('http://fhir.de/CodeSystem/bfarm/icd-10-gm')).extension", s);
    }
