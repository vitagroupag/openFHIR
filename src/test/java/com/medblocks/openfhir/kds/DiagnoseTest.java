...
//        - name: "codeIcd10Diagnosesicherheit"
    ...
    public JsonObject toOpenEhr() {
        ...
        Assert.assertEquals("2025-02-03T05:05:06",
                            jsonObject.get("diagnose/primärcode:0/feststellungsdatum").getAsString());
        Assert.assertEquals("active", jsonObject.get("diagnose/primärcode:0/klinischer_status/klinischer_status|code")
                .getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/condition-clinical",
                            jsonObject.get("diagnose/primärcode:0/klinischer_status/klinischer_status|terminology")
                                    .getAsString());
        Assert.assertEquals("Patient confirmed for secondary malignant neoplasm of lymph node.",
                            jsonObject.get("diagnose/primärcode:0/diagnoseerläuterung").getAsString());
        ...
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/primärcode:0/lebensphase/beginn|terminology").getAsString());
        Assert.assertEquals("Start of adulthood phase",
                            jsonObject.get("diagnose/primärcode:0/lebensphase/beginn|value").getAsString());
        Assert.assertEquals("367640001", jsonObject.get("diagnose/primärcode:0/lebensphase/ende|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/primärcode:0/lebensphase/ende|terminology").getAsString());
        Assert.assertEquals("End of middle age phase",
                            jsonObject.get("diagnose/primärcode:0/lebensphase/ende|value").getAsString());
        Assert.assertEquals("321667001",
                            jsonObject.get("diagnose/primärcode:0/körperstelle_-_snomed-ct|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/primärcode:0/körperstelle_-_snomed-ct|terminology").getAsString());
        Assert.assertEquals("C34.1", jsonObject.get("diagnose/primärcode:0/körperstelle_-_icd-o-3|code").getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/icd-o-3",
                            jsonObject.get("diagnose/primärcode:0/körperstelle_-_icd-o-3|terminology").getAsString());
        Assert.assertEquals("C34.1",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_icd-10-gm|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/bfarm/icd-10-gm",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_icd-10-gm|terminology")
                                    .getAsString());
        Assert.assertEquals("at0002", jsonObject.get(
                "diagnose/primärcode:0/multiple_coding_icd-10-gm/multiple_coding_identifier|code").getAsString());
        Assert.assertEquals("local", jsonObject.get(
                        "diagnose/primärcode:0/multiple_coding_icd-10-gm/multiple_coding_identifier|terminology")
                .getAsString());
        Assert.assertEquals("Primary code in multiple coding", jsonObject.get(
                "diagnose/primärcode:0/multiple_coding_icd-10-gm/multiple_coding_identifier|value").getAsString());
        Assert.assertEquals("L",
                            jsonObject.get("diagnose/primärcode:0/anatomical_location/laterality|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/dimdi/seitenlokalisation",
                            jsonObject.get("diagnose/primärcode:0/anatomical_location/laterality|terminology")
                                    .getAsString());
        Assert.assertEquals("Left side",
                            jsonObject.get("diagnose/primärcode:0/anatomical_location/laterality|value").getAsString());
        ...
        Assert.assertEquals("http://fhir.de/CodeSystem/dimdi/diagnosesicherheit",
                            jsonObject.get("diagnose/primärcode:0/diagnosesicherheit|terminology").getAsString());
        Assert.assertEquals("Confirmed diagnosis",
                            jsonObject.get("diagnose/primärcode:0/diagnosesicherheit|value").getAsString());
        Assert.assertEquals("057E3",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_alpha-id|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/bfarm/alpha-id",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_alpha-id|terminology")
                                    .getAsString());
        Assert.assertEquals("128462008",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_sct|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_sct|terminology").getAsString());
        Assert.assertEquals("1777",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_orphanet|code").getAsString());
        Assert.assertEquals("http://www.orpha.net",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_orphanet|terminology")
                                    .getAsString());
        Assert.assertEquals("C77.0",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_icd-o-3|code").getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/icd-o-3",
                            jsonObject.get("diagnose/primärcode:0/kodierte_diagnose_-_icd-o-3|terminology")
                                    .getAsString());
        Assert.assertEquals("2022-02-03T01:00:00", jsonObject.get("diagnose/context/start_time").getAsString());


        Assert.assertEquals("2125-02-03T05:05:06",
                            jsonObject.get("diagnose/sekundärcode:0/feststellungsdatum").getAsString());
        Assert.assertEquals("ref_active",
                            jsonObject.get("diagnose/sekundärcode:0/klinischer_status/klinischer_status|code")
                                    .getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/condition-clinical",
                            jsonObject.get("diagnose/sekundärcode:0/klinischer_status/klinischer_status|terminology")
                                    .getAsString());
        Assert.assertEquals(
                "ref_The patient has a history of high blood pressure, now presenting with severe hypertension.",
                jsonObject.get("diagnose/sekundärcode:0/diagnoseerläuterung").getAsString());
        Assert.assertEquals("ref_424144002",
                            jsonObject.get("diagnose/sekundärcode:0/lebensphase/beginn|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:0/lebensphase/beginn|terminology").getAsString());
        Assert.assertEquals("ref_Start of adulthood phase",
                            jsonObject.get("diagnose/sekundärcode:0/lebensphase/beginn|value").getAsString());
        Assert.assertEquals("ref_367640001",
                            jsonObject.get("diagnose/sekundärcode:0/lebensphase/ende|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:0/lebensphase/ende|terminology").getAsString());
        Assert.assertEquals("ref_End of middle age phase",
                            jsonObject.get("diagnose/sekundärcode:0/lebensphase/ende|value").getAsString());
        Assert.assertEquals("ref_368209003",
                            jsonObject.get("diagnose/sekundärcode:0/körperstelle_-_snomed-ct|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:0/körperstelle_-_snomed-ct|terminology")
                                    .getAsString());
        Assert.assertEquals("ref_C34.1",
                            jsonObject.get("diagnose/sekundärcode:0/körperstelle_-_icd-o-3|code").getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/icd-o-3",
                            jsonObject.get("diagnose/sekundärcode:0/körperstelle_-_icd-o-3|terminology").getAsString());
        Assert.assertEquals("ref_C34.1",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_icd-10-gm|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/bfarm/icd-10-gm",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_icd-10-gm|terminology")
                                    .getAsString());
        Assert.assertEquals("at0002", jsonObject.get(
                "diagnose/sekundärcode:0/multiple_coding_icd-10-gm/multiple_coding_identifier|code").getAsString());
        Assert.assertEquals("local", jsonObject.get(
                        "diagnose/sekundärcode:0/multiple_coding_icd-10-gm/multiple_coding_identifier|terminology")
                .getAsString());
        Assert.assertEquals("ref_Primary code in multiple coding", jsonObject.get(
                "diagnose/sekundärcode:0/multiple_coding_icd-10-gm/multiple_coding_identifier|value").getAsString());
        Assert.assertEquals("ref_U", jsonObject.get("diagnose/sekundärcode:0/anatomical_location/laterality|code")
                .getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/dimdi/seitenlokalisation",
                            jsonObject.get("diagnose/sekundärcode:0/anatomical_location/laterality|terminology")
                                    .getAsString());
        Assert.assertEquals("ref_Upper lobe",
                            jsonObject.get("diagnose/sekundärcode:0/anatomical_location/laterality|value")
                                    .getAsString());
        Assert.assertEquals("ref_S", jsonObject.get("diagnose/sekundärcode:0/diagnosesicherheit|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/dimdi/diagnosesicherheit",
                            jsonObject.get("diagnose/sekundärcode:0/diagnosesicherheit|terminology").getAsString());
        Assert.assertEquals("ref_Suspected diagnosis",
                            jsonObject.get("diagnose/sekundärcode:0/diagnosesicherheit|value").getAsString());
        Assert.assertEquals("ref_098H5",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_alpha-id|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/bfarm/alpha-id",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_alpha-id|terminology")
                                    .getAsString());
        Assert.assertEquals("ref_254626006",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_sct|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_sct|terminology")
                                    .getAsString());
        Assert.assertEquals("ref_830",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_orphanet|code").getAsString());
        Assert.assertEquals("http://www.orpha.net",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_orphanet|terminology")
                                    .getAsString());
        Assert.assertEquals("ref_C34.1",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_icd-o-3|code").getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/icd-o-3",
                            jsonObject.get("diagnose/sekundärcode:0/kodierte_diagnose_-_icd-o-3|terminology")
                                    .getAsString());


        Assert.assertEquals("ref1_active",
                            jsonObject.get("diagnose/sekundärcode:1/klinischer_status/klinischer_status|code")
                                    .getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/condition-clinical",
                            jsonObject.get("diagnose/sekundärcode:1/klinischer_status/klinischer_status|terminology")
                                    .getAsString());
        Assert.assertEquals(
                "ref1_The patient has a history of high blood pressure, now presenting with severe hypertension.",
                jsonObject.get("diagnose/sekundärcode:1/diagnoseerläuterung").getAsString());
        Assert.assertEquals("ref1_424144002",
                            jsonObject.get("diagnose/sekundärcode:1/lebensphase/beginn|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:1/lebensphase/beginn|terminology").getAsString());
        Assert.assertEquals("ref1_Start of adulthood phase",
                            jsonObject.get("diagnose/sekundärcode:1/lebensphase/beginn|value").getAsString());
        Assert.assertEquals("ref1_367640001",
                            jsonObject.get("diagnose/sekundärcode:1/lebensphase/ende|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:1/lebensphase/ende|terminology").getAsString());
        Assert.assertEquals("ref1_End of middle age phase",
                            jsonObject.get("diagnose/sekundärcode:1/lebensphase/ende|value").getAsString());
        Assert.assertEquals("ref1_368209003",
                            jsonObject.get("diagnose/sekundärcode:1/körperstelle_-_snomed-ct|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:1/körperstelle_-_snomed-ct|terminology")
                                    .getAsString());
        Assert.assertEquals("ref1_C34.1",
                            jsonObject.get("diagnose/sekundärcode:1/körperstelle_-_icd-o-3|code").getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/icd-o-3",
                            jsonObject.get("diagnose/sekundärcode:1/körperstelle_-_icd-o-3|terminology").getAsString());
        Assert.assertEquals("ref1_C34.1",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_icd-10-gm|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/bfarm/icd-10-gm",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_icd-10-gm|terminology")
                                    .getAsString());
        Assert.assertEquals("at0002", jsonObject.get(
                "diagnose/sekundärcode:1/multiple_coding_icd-10-gm/multiple_coding_identifier|code").getAsString());
        Assert.assertEquals("local", jsonObject.get(
                        "diagnose/sekundärcode:1/multiple_coding_icd-10-gm/multiple_coding_identifier|terminology")
                .getAsString());
        Assert.assertEquals("ref1_Primary code in multiple coding", jsonObject.get(
                "diagnose/sekundärcode:1/multiple_coding_icd-10-gm/multiple_coding_identifier|value").getAsString());
        Assert.assertEquals("ref1_U", jsonObject.get("diagnose/sekundärcode:1/anatomical_location/laterality|code")
                .getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/dimdi/seitenlokalisation",
                            jsonObject.get("diagnose/sekundärcode:1/anatomical_location/laterality|terminology")
                                    .getAsString());
        Assert.assertEquals("ref1_Upper lobe",
                            jsonObject.get("diagnose/sekundärcode:1/anatomical_location/laterality|value")
                                    .getAsString());
        Assert.assertEquals("ref1_S", jsonObject.get("diagnose/sekundärcode:1/diagnosesicherheit|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/dimdi/diagnosesicherheit",
                            jsonObject.get("diagnose/sekundärcode:1/diagnosesicherheit|terminology").getAsString());
        Assert.assertEquals("ref1_Suspected diagnosis",
                            jsonObject.get("diagnose/sekundärcode:1/diagnosesicherheit|value").getAsString());
        Assert.assertEquals("ref1_098H5",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_alpha-id|code").getAsString());
        Assert.assertEquals("http://fhir.de/CodeSystem/bfarm/alpha-id",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_alpha-id|terminology")
                                    .getAsString());
        Assert.assertEquals("ref1_254626006",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_sct|code").getAsString());
        Assert.assertEquals("http://snomed.info/sct",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_sct|terminology")
                                    .getAsString());
        Assert.assertEquals("ref1_830",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_orphanet|code").getAsString());
        Assert.assertEquals("http://www.orpha.net",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_orphanet|terminology")
                                    .getAsString());
        Assert.assertEquals("ref1_C34.1",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_icd-o-3|code").getAsString());
        Assert.assertEquals("http://terminology.hl7.org/CodeSystem/icd-o-3",
                            jsonObject.get("diagnose/sekundärcode:1/kodierte_diagnose_-_icd-o-3|terminology")
                                    .getAsString());
